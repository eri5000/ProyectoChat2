             ...
             if(childKey !="purpose") {
               firebase_message_id = childKey;
                message_data = childData;
                 ...
                 name_with_tag = "<h4>" + name  + "<img class='user_tick' src= 'https://img.freepik.com/iconos-gratis/comprobado_318-197857.jpg'></h4>";
...
function updateLike(message_id){
  console.log("click en el boton like-" + message_id);
